<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="Plus"
          @click="handleAdd"
          v-hasPermi="['manage:categories:add']"
          >新增</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['manage:categories:edit']"
          >修改</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['manage:categories:remove']"
          >删除</el-button
        >
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['manage:categories:export']"
          >导出</el-button
        >
      </el-col>
      <right-toolbar
    ...
    >
      ...
      <!-- 分类下的新闻数量 -->
      <el-table-column label="新闻数量" align="center" prop="newsCount" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
...
function handleUpdate(row) {
  ...
  getCategories(_categoryId).then((response) => {
...
function handleDelete(row) {
  ...
  proxy.$modal
    .confirm('是否确认删除新闻分类编号为"' + _categoryIds + '"的数据项？')
    .then(function () {
      return delCategories(_categoryIds);
    })
    .then(() => {
      getList();
